---
question: Amazon or Flipkart — which should an Indian seller start with?
...
faqs:
  - question: Should I eventually sell on both?
    answer: Most sellers who reach any scale do. The catalogue work is largely reusable once it exists, so the second platform costs much less effort than the first. The mistake is launching on both simultaneously before you understand either — different fee structures, different fulfilment SLAs, different penalty regimes, all learned at once.
  - question: What about Meesho?
    answer: Meesho operates differently — a zero-commission model aimed squarely at price-sensitive buyers, heavily reseller-driven. It can move real volume in value categories, but margins are thin and brand-building is close to impossible there. It works as a volume channel alongside Amazon or Flipkart, rarely as your only one.
  - question: Which platform pays out faster?
    answer: It depends more on your seller tier than on the platform. Flipkart's higher tiers get materially faster settlement — Gold and above settle in roughly five business days after dispatch, against seven to fifteen for lower tiers. Amazon's cycle is more uniform but can be shortened with their fee-based faster-payment options.
related:
  - what-flipkart-gold-tier-gets-you
...
Commission and zero-fee changes from 2026 reporting including [YourStory](https://yourstory.com/2026/03/amazon-india-expands-zero-referral-fees-125-crore-products-flipkarts-commission-waiver), [GoNukkad](https://www.gonukkad.com/blog/marketplace-commission-comparison-india), and [GrowthJockey](https://www.growthjockey.com/blogs/amazon-vs-flipkart-for-sellers). Flipkart tier settlement timings from published seller-programme documentation. Category observations reflect the accounts we run.
