---
question: Gross revenue or net revenue — which should you judge an agency on?
...
faqs:
  - question: Do ad platforms report gross or net?
    answer: Gross, always. Meta and Google record a conversion when the order is placed. Neither platform knows whether the parcel was delivered, refused, or returned three weeks later. Every ROAS figure you see in an ad dashboard is a gross figure, which is why it consistently looks better than your bank statement.
  - question: How do I calculate my real ROAS?
    answer: Take the platform's reported conversion value, multiply by (1 − your RTO rate), then divide by ad spend. At a reported 4.0x with a 25% RTO rate, your real return is closer to 3.0x. Do this once and it changes how you read every report afterwards.
  - question: Is any agency actually paid on net?
    answer: Very few. Most charge a flat retainer or a percentage of ad spend, and neither is affected by whether orders get delivered. Orcas Prime charges 3.5% + GST of net sales after returns and RTOs, which is unusual specifically because it puts return rate on our side of the ledger too.
related:
...
Full detail on [the pricing page](/pricing).

## Sources

RTO rate ranges from published Indian logistics and D2C analyses, 2026, including [GoKwik](https://www.gokwik.co/blog/what-is-return-to-origin-rto-in-ecommerce) and [Shipmozo](https://www.shipmozo.com/blog/how-to-reduce-rto-in-ecommerce). Worked examples are illustrative arithmetic — substitute your own RTO rate and margin.
