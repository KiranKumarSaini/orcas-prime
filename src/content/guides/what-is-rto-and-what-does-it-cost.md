---
question: What is RTO in ecommerce, and how much does it actually cost you?
...
faqs:
  - question: Is RTO the same as a customer return?
    answer: No. A customer return means the buyer received the parcel and sent it back. An RTO means the parcel never reached them — refused at the door, address not found, or nobody available after repeated attempts. RTO is worse because you paid shipping both ways and never had a satisfied customer at any point.
  - question: Does prepaid have RTO too?
    answer: Yes, but far less. Prepaid RTO is usually an address or availability failure rather than a change of mind, because the buyer has already parted with money. This is why shifting even a modest share of orders from COD to prepaid moves the overall RTO number noticeably.
  - question: Can you claim RTO costs back from the courier?
    answer: Sometimes. If the courier marked a delivery attempt that did not happen, or lost the parcel on the return leg, that is disputable. Filing those claims consistently is tedious and most sellers do not bother, which is exactly why the money is there to recover.
related:
...
RTO rate ranges from published Indian logistics and D2C industry analyses, 2026, including [GoKwik](https://www.gokwik.co/blog/what-is-return-to-origin-rto-in-ecommerce), [Shiprocket-ecosystem reporting](https://blog.shipway.com/how-to-effectively-reduce-e-commerce-rto-in-2026/), and [Shipmozo](https://www.shipmozo.com/blog/how-to-reduce-rto-in-ecommerce). Cost figures in the worked example are illustrative arithmetic, not client data — substitute your own shipping rate and CPA.
